<template>
  <div class="footer p-4 flex flex-col items-center text-xs">
    <div id="cdn-div" class="flex flex-row gap-1 items-center" style="display: none;">
      ...
      <div id="EdgeCast" class="flex flex-row gap-1 items-center" style="display: none;">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 504 117.5" style="enable-background:new 0 0 504 117.5;" xml:space="preserve" width="4.2em" height="1.5em">
          <g><g>
      ...
      <div id="Tencent" class="flex flex-row gap-1 items-center" style="display: none;">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" id="Layer_1" x="0px" y="0px" viewBox="0 0 1053 719.6" style="enable-background:new 0 0 1053 719.6;" xml:space="preserve" width="1.8em" height="1.8em">
      ...
      <div id="Randall" class="flex flex-row gap-1 items-center" style="display: none;">
        <a href="https://randallanjie.com/"><img src="/r-logo.png" alt="Randall" width="20em" height="20em"></a>
        提供加速服务
      </div>
    </div>
...
#EdgeCast .st0{fill:#6001D2;}
#Alibaba .st0{fill:#ED6B1E;}
#Tencent {
  .st0{fill:#949495;}
  .st1{fill:#00A3FF;}
  .st2{fill:#00C8DC;}
